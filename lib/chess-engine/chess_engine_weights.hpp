...
EXTERN const int8_t stat_weight_black[7][64]
#if _WEIGHTS_
  = {
    ...
    { -50, -40, -30, -20, -20, -30, -40, -50, //king endgame
...
EXTERN const int8_t stat_weight_white[7][64]
#if _WEIGHTS_
  = {
    {   0,   0,   0,   0,   0,   0,   0,   0, //pawn
    ...
    { -50, -30, -30, -30, -30, -30, -30, -50, //kingb endgame
      -30, -30,   0,   0,   0,   0, -30, -30,
      -30, -10,  20,  30,  30,  20, -10, -30,
      -30, -10,  30,  40,  40,  30, -10, -30,
      -30, -10,  30,  40,  40,  30, -10, -30,
